...
struct PhysiqueTabView: View {
    ...
    var failuresSection: some View {
        VStack(spacing: metrics.blockSpacing) {
            ...
            failCard2("01", "Doing too much because compliance is high",
                     "High compliance does not imply infinite recovery. At 5:00 wake, active Hideout shift, caloric deficit, and PM lifting — the recovery ceiling is 65–80 true weekly sets. Adding volume because 'it feels manageable' accumulates a debt that shows up 3 weeks later as stalled progress and persistent flatness.",
            ...
            failCard2("03", "Sleep compression",
                     "5:00 wake + 9:30 PM sleep = 6.5 hour ceiling. Any disruption below 6 hours elevates cortisol, suppresses GH release, and directly impairs fat loss regardless of perfect nutrition. The hormonal environment during sleep is a required input for the cut to work.",
    ...
    func mealRailView() -> some View {
        VStack(spacing: metrics.cardSpacing) {
            mealRailRow2("5:02", "Wake + creatine", "Water only. Fasted.", false)
