...
struct FieldManualTabView: View {
    ...
    let entries: [FieldManualEntry] = [
        ...
        FieldManualEntry(
            ...
            usageTrigger: "When progress is not visible. Review completion history. The record is the evidence."
        ),
        FieldManualEntry(
                    ...
                    Button(action: {
                        ...
                        .overlay(
                            RoundedRectangle(cornerRadius: 14)
                                .strokeBorder(
                                    isExpanded ? Color.violetLight.opacity(0.15) : Color.white.opacity(0.04),
                                    lineWidth: 0.5
                                )
                        )
                    }
