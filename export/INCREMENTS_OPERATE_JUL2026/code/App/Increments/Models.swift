...
//             Every day: 5:00–5:45 morning anchor stack (5:00 wake target)
...
enum DayType: String, Codable {
    ...
    // Brice's schedule (5:00 wake target):
...
class OperatorProfile {
    ...
    var notifQuietEnd: Int = 5      // hour (24h): quiet window end (5am wake)
    ...
    func homeGreeting(completedToday: Int) -> String {
        ...
        case .earlyMorning:
            ...
            return "\(address)5:00. Morning anchor. Full day ahead."
        case .morning:
...
class AppState {
    ...
    /// Deep-link into Park tab (Hideout, You, …) without losing Operate as default.
    var parkRoute: ParkDestination? = nil
