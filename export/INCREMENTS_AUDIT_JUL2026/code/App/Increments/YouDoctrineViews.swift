    ...
    var body: some View {
        VStack(alignment: .leading, spacing: metrics.sectionGap) {
            ...
            DoctrineSubsection(
                ...
                accent: .violetLight,
                paragraphs: [
                    "Tibia ~95% · late Phase II. Progressive load cleared. Running return path active — bike/elliptical primary until treadmill protocol earns outdoor. Rod at Panorama Mon/Fri 6:15AM is coaching, separate from Forge Breechay.",
                    "FORM coaching on threshold Tuesdays and long run Saturdays continues — the intelligence layer is visible when you are not running personally. That is rarer content than any run recap."
                ]
            )
        ...
        VStack(alignment: .leading, spacing: metrics.sectionGap) {
            ...
            DoctrineSubsection(
                ...
                paragraphs: [
                    ...
                    "The solo operator phase makes this visible: without staff, every transaction is a direct exchange. The question is not only whether you hit the revenue target but what hitting it cost, and whether the cost was worth it.",
