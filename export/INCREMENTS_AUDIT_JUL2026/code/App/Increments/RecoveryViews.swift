...
extension RecoveryTabView {
    ...
    private var phaseBiology: String {
        ...
        case .phaseII:
            return "Hard callus confirmed. Progressive axial loading accelerates cortical remodeling. Tibia ~95% — lower body training reintegration active. Watch 24h pain response; drop one week if tibial ache persists."
        case .phaseIII:
    ...
    private var phaseGateText: String {
        switch currentStage {
        case .phaseI:   return "Ortho cleared · callus confirmed"
        case .phaseII:  return "Jul 2026 · ~95% · progressive load active"
        case .phaseIII: return "~Oct · Physician signoff · full training"
    ...
    private var railGateText: String {
        switch currentStage {
        case .phaseI:   return "Ortho cleared"
        case .phaseII:  return "~95% · progressive load"
        case .phaseIII: return "~Oct · Signoff"
        case .phaseIV:  return "Full capacity"
        }
    }
